...
#ifndef _FLUKE_STREAM_H_
#define _FLUKE_STREAM_H_
...
namespace fluke {
    ...
    /// \class StreamManager
    /// \brief Handles the file streams of \b Fluke.
    ///
    ...
    /// directory is created. It is of the format \c xxx-xxx-xxx-xxx, where
    ...
    class StreamManager {
        public:
            ...
            typedef std::list< boost::filesystem::ifstream* >::iterator 
                infile_iter;
            typedef std::list< boost::filesystem::ofstream* >::iterator 
                outfile_iter;

        public:
            /// Constructor. A pointer to \c Fluke is needed for getting to
