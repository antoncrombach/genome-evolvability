...
#ifndef _FLUKE_OBSERVER_H_
#define _FLUKE_OBSERVER_H_
...
namespace fluke {
    ...
    class LogObserver : public Observer {
        public:
            /// Constructor. \c StreamManager manages filestreams, the integer
            /// specifies the period of logging (in simulation timesteps).
            LogObserver( StreamManager *, long );
            /// Copy constructor
    ...
    class AsyncLogObserver : public Observer {
        public:
            /// Constructor. \c StreamManager manages filestreams, the integer
            /// specifies the period of logging (in simulation timesteps).
            AsyncLogObserver( StreamManager * );
            /// Copy constructor
