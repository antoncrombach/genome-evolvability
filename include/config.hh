...
namespace fluke {
    ...
    class Config {
        ...
        public:
            ...
            std::vector< int > optionAsVector( const std::string & );

            /// Return the option as an integer
            int optionAsInt( const std::string &, int );
            /// Return the option as a long integer
            long optionAsLong( const std::string &, int );
            /// Return the option as a floating point
            double optionAsDouble( const std::string &, int );
            /// Return the option as a string
            std::string optionAsString( const std::string &, int );
            /// Return the option as a vector of integers
            std::vector< int > optionAsVector( const std::string &, int );
