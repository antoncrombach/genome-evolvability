...
#ifndef _FLUKE_POOL_H_
#define _FLUKE_POOL_H_
...
namespace fluke {
    ...
    class ObjectCache {
        ...
        /// instances is reached, just delete the object.
        void returnObject( T* );
    ...
    #ifdef DEBUG
            std::cout << "! pool maximally filled" << std::endl;
    #endif
            delete obj;
        } else {
            pool_.push( obj );
    ...
    ObjectCache< T >::instance() {
        if( instance_ == 0 ) {
            instance_ = new ObjectCache< T >( /*65536*/ 16384 );
        }
        return instance_;
    }
